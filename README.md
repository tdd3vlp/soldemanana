# 🇪🇸 Sol de Mañana — Telegram-бот для изучения испанского языка
...
- ✅ **Лимиты сообщений**: FREE (10/день), BASIC (50/день), PREMIUM (безлимит)
...
- ⏳ Голосовые сообщения через Whisper API (для PREMIUM подписчиков)
- ⏳ Личный словарь с экспортом (платная функция)
- ⏳ Новые режимы практики
...
2. **⚙️ Настройки** — измени уровень, цель, режим исправлений
